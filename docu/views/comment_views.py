...
def comment_create_question(request, question_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('{}#comment_{}'.format(resolve_url('docu:detail', question_id=comment.question.id), comment.id))
    else:
        form = CommentForm()
    context = {'form': form}
...
def comment_create_answer(request, answer_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comment.save()
            return redirect('{}#comment_{}'.format(resolve_url('docu:detail', question_id=comment.answer.question.id), comment.id))
    else:
        form = CommentForm()
    context = {'form': form}
    return render(request, 'docu/comment_form.html', context)
